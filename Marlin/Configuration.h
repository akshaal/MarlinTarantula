...
#define PID_MAX 255 // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // TEVO Tarantula Custom PID Settings - Hotend - Stock hotend
  // #define  DEFAULT_Kp 11.72
  // #define  DEFAULT_Ki 0.60
  // #define  DEFAULT_Kd 57.12

  // E3D V6 Clone (added by here by Akshaal)
  // #define DEFAULT_Kp 13.53
  // #define DEFAULT_Ki 1.69
  // #define DEFAULT_Kd 27.15

  // E3D V6 Clone (added by here by Akshaal) Pid autocalibration without FAN by using: M303 S250 C10
  // #define  DEFAULT_Kp 24.29
  // #define  DEFAULT_Ki 3.30
  // #define  DEFAULT_Kd 44.78

  // E3D V6 Clone (added by here by Akshaal) Pid autocalibration with FAN by using: M303 S250 C10
#define  DEFAULT_Kp 24.45
#define  DEFAULT_Ki 3.21
#define  DEFAULT_Kd 46.56
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //#define  DEFAULT_bedKd 1675.16
    ...
    // Tevo Tarantula Custom PID by Askhaal PID auto-cailbration using: M303 E-1 S90 C10
    #define  DEFAULT_bedKp 376.87
    #define  DEFAULT_bedKi 73.02
    #define  DEFAULT_bedKd 486.26
...
//#define ENDSTOPPULLUPS // Comment this out (using // at the start of the line) to disable the endstop pullup resistors
  ...
  //#define ENDSTOPPULLUP_ZMIN  // Changed by AKSHAAL
  #define ENDSTOPPULLUP_ZMIN_PROBE // Set by AKSHAAL
#endif

// Mechanical endstop with COM to ground and NC to Signal uses "false" here (most common setup).
#define X_MIN_ENDSTOP_INVERTING true // set to true to invert the logic of the endstop.
#define Y_MIN_ENDSTOP_INVERTING true // set to true to invert the logic of the endstop.
#define Z_MIN_ENDSTOP_INVERTING false // Changed by AKSHAAL set to true to invert the logic of the endstop.
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN // CHANGED BY AKSHAAL
 ...
 */
#define FIX_MOUNTED_PROBE // CHANGED BY AKSHAAL
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 0  // CHANGED BY AKSHAAL: X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER 75 // CHANGED BY AKSHAAL: Y offset: -front +behind [the nozzle]
...
#define Z_PROBE_SPEED_SLOW (Z_PROBE_SPEED_FAST / 5) // CHANGE BY AKSHAAL
...
#define Z_MIN_PROBE_REPEATABILITY_TEST // Changed by AKSHAAL
...
#define INVERT_Y_DIR true     // Change by Akshaal
#define INVERT_Z_DIR true     // Change by Akshaal
...
#define AUTO_BED_LEVELING_BILINEAR  // CHANGED BY AKSHAAL
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 4 // CHANGED BY AKSHAAL
  ...
  #define UBL_MESH_INSET 20          // CHANGED BY AKSHAAL: Mesh inset margin on print area
  #define GRID_MAX_POINTS_X 10      // Don't use more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
  #define UBL_PROBE_PT_1_X 39       // Probing points for 3-Point leveling of the mesh
  #define UBL_PROBE_PT_1_Y 130      // CHANGED BY AKSHAAL
  #define UBL_PROBE_PT_2_X 39
  #define UBL_PROBE_PT_2_Y 80       // CHANGED BY AKSHAAL
  #define UBL_PROBE_PT_3_X 130      // CHANGED BY AKSHAAL
  #define UBL_PROBE_PT_3_Y 80       // CHANGED BY AKSHAAL
  ...
  #define MESH_INSET 40          // CHANGED BY AKSHAAL: Mesh inset margin on print area
...
//
#define Z_SAFE_HOMING  // CHANGED BY AKSHAAL
